...
- **Names and client codes are masked.** Deal names repeat across unrelated rows, so never treat a deal name as a unique identifier or report a repeated name as one account. Client codes also differ in format between the two boards.
